...
use crate::editor::{DiagnosticLanguage, LintCode, LintIssue, NodeGraph, StoryNode};
...
mod tests {
    use super::*;
    use crate::editor::{validate_graph, ValidationPhase};
    ...
    fn safe_fix_suggestions_exist_for_common_issue() {
        ...
        let issue = validate_graph(&graph)
            .into_iter()
            .find(|issue| {
                issue.node_id == Some(node_id) && issue.code == LintCode::EmptySpeakerName
            })
